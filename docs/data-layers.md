...
| Piracy | IMB Piracy Reporting Centre | Active current-year public-map incident snapshot |
| Commodity prices | World Bank Pink Sheet | Active monthly cocoa, coffee, wheat and copper benchmarks; not live futures |
...
Run `npm run data:intelligence` to refresh NSIDC, IMB, Panama Canal, and World Bank snapshots. Each generated file preserves its observation date and source. Public benchmark values are never labeled as live futures quotes.
