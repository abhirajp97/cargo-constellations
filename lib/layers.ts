...
export const DATA_LAYERS: DataLayer[] = [
  { id: "delayed-voyages", label: "Long cargo voyages", source: "Global Fishing Watch", status: "credential", description: "Identity-preserving cargo sequences built from four days of daily gridded AIS presence, delayed by approximately four days across five major shipping corridors.", defaultOn: true },
